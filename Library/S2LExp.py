...
class S2LExp(Selenium2Library, _patches, _keywords):
	"""*S2LExp*\n
	_Selenium 2 Library Expansion_\n
	---
	...
	S2LExp implements new element location strategies on top of the original location strategies from Selenium2Library. For
	...
	def __init__(self, timeout=10.0, implicit_wait=0.0, run_on_failure='Capture Page Screenshot', screenshot_root_directory=None):
		"""S2LExp can be imported with the same arguments as Selenium2Library. See the
